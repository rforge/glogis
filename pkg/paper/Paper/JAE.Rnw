...
%% additional packages
\usepackage{amsfonts,amstext,amsmath,a4wide,graphicx,color,thumbpdf}
\usepackage{hyperref}
...
\fancyhead[CE]{{\normalsize \uppercase{T.~Windberger and A.~Zeileis}}}
\fancyhead[CO]{{\normalsize \uppercase{Structural Breaks in Inflation Dynamics within the EMU}}} 
% \fancyfoot[LO,LE]{\small Copyright {\copyright} 20XX John Wiley \& Sons, Ltd.}
\fancypagestyle{plain}{
\fancyhf{}
% \fancyfoot[LO,LE]{\small This is a preprint of an article published in %
%   \textit{Journal of Applied Econometrics}, \textbf{XX}(X), XXX--XXX. \\%
%   Copyright {\copyright} 20XX John Wiley \& Sons, Ltd. \doi{10.1002/jae.XXXX} }
}

%% title information
\title{\bf Structural Breaks in Inflation Dynamics within the European Monetary Union}
...
\hypersetup{%
  pdftitle = {Structural Breaks in Inflation Dynamics within the European Monetary Union},
  pdfsubject = {},
  pdfkeywords = {inflation rate, structural break, EMU, generalized logistic distribution},
  pdfauthor = {Thomas Windberger, Achim Zeileis},
...
\noindent {\bf Keywords:} inflation rate, structural break, EMU, generalized logistic distribution.
