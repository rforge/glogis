...
%trellis.par.set(theme = standard.theme(color = FALSE))
%print(xyplot(cbind(results$Austria$data, results$Demark$data, results$France$data, results$Germany$data, results$Portugal$data), xlab="Time", ylab="", main="", screens=list("Austria", "Denmark", "France", "Germany", "Portugal"), ylim=c(-2,2)))
%@
