  ...
  probs = c(0.25, 0.5, 0.75))
{
  rval <- sapply(countries, function(country) {
    ...
    m[sum(as.yearmon(date) > bd) + 1, ]
  })
  apply(rval, 1, quantile, probs = probs)
}
...
format_cross_country <- function(crossmom, digits = 6, name="Euro") {
...
% wichtig: http://sdw.ecb.europa.eu/quickview.do?SERIES_KEY=122.ICP.M.U2.N.000000.4.ANR
% sieht man die daten von sales prices: 1999-1 portugal,  2000-1 lux, 2001-1 bel, 2002 ita-spa (allerdings in anderem paper ein jahr früher) hm
...
% if(!file.exists(file.path(root_dir, "Paper", "draft-greyplot.pdf"))) 
...
Regarding the general trend, Table \ref{grouptable} presents lower, medium and upper (25, 50, 75) percentiles of the first three moments of the inflation series  at the beginning of the convergence phase (January 1995), in December 2007 as a point in time before the financial crisis  and for the last observation in the sample. The countries are grouped into the ``core'' of the eurozone (Austria, Belgium, Finland, France, Germany, Luxembourg and Netherlands), the PIIGS countries (Portugal, Italy, Ireland, Greece and Spain) and all the others.  \\



\begin{longtable}{|l|l|l|l|l|}
\hline
\multicolumn{5}{|c|}{1995} \\
\hline
Zone & Percentile & Mean & Variance & Skewness\\
\hline
<<echo=FALSE, results=tex>>=
euro <- c(1, 2, 6, 7, 8, 13, 14)
noneuro <- c(3, 4, 5, 10, 15, 17, 18, 20, 21)
piigs <- c(9, 11, 12, 16, 19)
writeLines(format_cross_country(cross_country_moments(euro, 1995), name ="Euro"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(piigs, 1995), name ="PIIGS"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(noneuro, 1995), name ="Noneuro"))
@
\hline
\multicolumn{5}{|c|}{2007(12)} \\
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(euro, 2007+11/12), name ="Euro"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(piigs, 2007+11/12), name ="PIIGS"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(noneuro, 2007+11/12), name ="Noneuro"))
@
\hline
\multicolumn{5}{|c|}{2010(12)} \\
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(euro, 2010+11/12), name ="Euro"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(piigs, 2010+11/12), name ="PIIGS"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(noneuro, 2010+11/12), name ="Noneuro"))
@
\hline
...
Regarding the mean, there is a slight increase in median inflation in the euro countries, with a bigger increase in the PIIGS countries, whereas the other countries witness a strong decrease in inflation (as a result of their efforts to reach the qualifications required for eurozone entry). The variance for the euro countries almost triples over the past 15 years, whereas the variance of the PIIGS countries decreases slightly. Regarding skewness, in the euro countries and the PIIGS, there is a tendency of decreasing skewness, indicating a shift of the distribution to the right, whereas the  countries outside the euro do not show much change.\readme{this way, there is a completely different story, not the big changes that we get if we take whole subperiods in the data.}
