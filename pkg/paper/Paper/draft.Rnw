...
@
\hline
\multicolumn{5}{|c|}{2008(9)} \\
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(euro, 2008+8/12), name ="Euro"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(piigs, 2008+8/12), name ="PIIGS"))
@
\hline
<<echo=FALSE, results=tex>>=
writeLines(format_cross_country(cross_country_moments(noneuro, 2008+8/12), name ="Noneuro"))
@
\hline
