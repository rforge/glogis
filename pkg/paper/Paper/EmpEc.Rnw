...
critical value at 5\% level (horizontal red line), and estimated breakpoint (vertical dashed line).}
...
segment of Spain, where the Ljung-box shows that not all of the autocorrelation has been captured.
...
1990s. With regard to the last segment for both countries, the Ljung-box suggests that 
