...
Section~\ref{sec:fcrisis} focuses on the question of changes
in the inflation dynamics during the 2008/2009 financial crisis. Finally, the model fit and related issues will be discussed in Section~\ref{sec:fit}
...
suggest any problems in this segment.
...
first phase of convergence. However, with HAC correction, the very short segment of France would not be
segregated, thereby suggesting that France belongs to the group of countries which did not change at all.
In these countries,
...
rates, which are closer to the levels of the previous two groups. The diagnostics for model fits in 
this group are unproblematic.
...
over an extended period of time. For the middle segment of Spain, the Ljung-box shows that not all
of the autocorrelation has been captured. In Spain, which was affected by a housing bubble of  
...
1990s. With regard to the last segment for both countries, the Ljung-box suggests that the data 
in this segment is independently distributed. Anyhow, the HAC correction would also suggest two breaks 
for both series.
...
late 1990s or early 2000s. For Estonia and Slovakia, the $\chi^2$ goodness-of-fit suggests that the generalized logistic distribution
might not be the most suitable distribution for this purpose. Also, compared to other country groups, the 
Eastern European group shows the highest occurrence of non-captured autocorrelation. Nevertheless, compared to other 
inflation rates, these series show the most dynamic behaviour.
