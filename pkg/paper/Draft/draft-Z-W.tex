\documentclass[a4paper, 5p, preprint]{elsarticle}
...
\author[rvt]{A.˜Zeileis}
\author[focal]{T.˜Windberger}
\address[rvt]{University of Innsbruck, Institute for Statistics, Universitätsstraße 15, 6020 Innsbruck, Austria}
\address[focal]{University of Innsbruck, Austria}
...
An enhancement to the already existing R package "`strucchange"', which currently does not support a generalized logistic distribution (GL) is provided with this paper. The asymptotic testing theory still holds for this generalization. [Beweis] \\
...
\subsubsection{Cramér-von Mises statistic - \\ Nyblom Hansen Test}

We use the Cramér von Mises type test as given in \citet{z07}. The test statistic is given by:
...
\end{tabular}
\caption{\label{tab:breakpoints} Dating of break points.}
\subcaption{First date: entry to ERM~II, second date: EURO introduction.}
\end{center}
\end{table}
